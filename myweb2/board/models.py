...
class Board(models.Model):
    ...
    filename=models.CharField(null=True,blank=True, default=True,
                              max_length=500) #첨부파일 이름
    ...
    def down_up(self):
        self.down += 1 #다운로드 횟수 증가 처리

#댓글 클래스
class Comment(models.Model):
    idx=models.AutoField(primary_key=True) #댓글 번호
    board_idx=models.IntegerField(null=False) #원글의 번호
    writer=models.CharField(null=False, max_length=50) #댓글 작성자 이름
